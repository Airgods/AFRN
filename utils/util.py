...
def dataset_path(args):
    ...
    if args.dataset == 'cub_cropped':
        ...
        fewshot_path = os.path.join(data_path, 'miniImageNet')
    elif args.dataset == 'fc100':
        fewshot_path = os.path.join(data_path, 'fc100')
...
def get_save_path(args):
    ...
    if args.dataset == 'cub_cropped':
        ...
        path = os.path.join(path, 'flowers')
    elif args.dataset == 'dogs':
        path = os.path.join(path, 'dogs')
    elif args.dataset == 'miniImageNet':
        path = os.path.join(path, 'miniImageNet')
    elif args.dataset == 'fc100':
        path = os.path.join(path, 'fc100')
    elif args.dataset == 'tieredImageNet':
        path = os.path.join(path, 'tiered-ImageNet')
