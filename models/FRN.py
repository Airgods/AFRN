...
class FRN(nn.Module):
    ...
    def get_neg_l2_dist(self, inp, way, shot, query_shot, return_support=False):
        ...
        feature_map_new = feature_map[way * shot:] 
        feature_map_new = feature_map_new.view(way*query_shot,-1)  
        ...
        if return_support:
            return neg_l2_dist, support.view(way, shot * resolution, d), feature_map_new
        else:
            return neg_l2_dist
    ...
    def forward(self, inp):
        ...
        neg_l2_dist, support, feature_map_new = self.get_neg_l2_dist(inp=inp,
                                                    way=self.way,
                                                    shot=self.shots[0],
        ...
        return log_prediction, support, feature_map_new